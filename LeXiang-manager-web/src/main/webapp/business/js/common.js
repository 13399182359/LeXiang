...
var shopxx = {
    base: "/shopxxb2b2c-5.0.2-SNAPSHOT",
    locale: "zh_CN"
};
...
(function($) {
    ...
    $.redirectLogin = function(redirectUrl) {
        var loginUrl = "/shopxxb2b2c-5.0.2-SNAPSHOT/member/login";
        if ($.trim(redirectUrl) != "") {
...
(function($) {
    ...
    $.fn.captchaImage.defaults = {
        ...
        imgSrc: function(captchaIdParameterName, captchaId) {
            return "/shopxxb2b2c-5.0.2-SNAPSHOT/common/captcha/image?" + captchaIdParameterName + '=' + captchaId + '&timestamp=' + new Date().getTime();
        },
        imgTitle: "点击更换验证码",
...
$().ready(function() {
    ...
    setInterval(function() {
        if (cartInfo == null || cartInfo.tag != getCookie("cartTag")) {
            $.ajax({
                url: "/shopxxb2b2c-5.0.2-SNAPSHOT/cart/info",
                type: "GET",
                dataType: "json",
