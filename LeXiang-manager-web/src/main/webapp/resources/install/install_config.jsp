...
<%
	...
	if (!failed) {
		...
		logoElement.attribute("value").setValue(base + "/image/logo.png");
		defaultLargeProductImageElement.attribute("value").setValue(base + "/image/default_large.jpg");
		defaultMediumProductImageElement.attribute("value").setValue(base + "/image/default_medium.jpg");
		defaultThumbnailProductImageElement.attribute("value").setValue(base + "/image/default_thumbnail.jpg");
		defaultStoreLogoElement.attribute("value").setValue(base + "/image/default_store_logo.jpg");
